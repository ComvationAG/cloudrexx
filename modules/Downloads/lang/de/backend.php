...
$_ARRAYLANG['TXT_DOWNLOADS_SETTINGS'] = "Einstellungen";
...
$_ARRAYLANG['TXT_DOWNLOADS_TYPE_DOCUMENT'] = "Dokument";
$_ARRAYLANG['TXT_DOWNLOADS_TYPE_MEDIA'] = "Medium";
$_ARRAYLANG['TXT_DOWNLOADS_TYPE_ARCHIVE'] = "Archiv";
$_ARRAYLANG['TXT_DOWNLOADS_TYPE_APPLICATION'] = "Anwendung";
...
$_ARRAYLANG['TXT_DOWNLOAD_ENTER_CURRENT_PASSWORD'] = "Geben Sie Ihr aktuelles Passwort ein";
$_ARRAYLANG['TXT_DOWNLOAD_FIRSTNAME'] = "Vorname";
$_ARRAYLANG['TXT_DOWNLOAD_INVALID_PASSWORD'] = "Ungültiges neues Passwort";
$_ARRAYLANG['TXT_DOWNLOAD_PASSWORD_CHANGE'] = "ändern";
$_ARRAYLANG['TXT_DOWNLOAD_PASSWORD_CHANGED_SUCCESSFULLY'] = "Das Passwort wurde geändert";
$_ARRAYLANG['TXT_DOWNLOAD_PASSWORD_CONFIRM'] = "Neues Passwort wiederholen";
$_ARRAYLANG['TXT_DOWNLOAD_PASSWORD_CURRENT'] = "Aktuelles Passwort";
...
$_ARRAYLANG['TXT_DOWNLOAD_SPECIFY_NEW_PASSWORD'] = "Geben Sie Ihr neues Passwort an";
$_ARRAYLANG['TXT_DOWNLOAD_SURNAME'] = "Nachname";
$_ARRAYLANG['TXT_DOWNLOAD_UNABLE_SET_NEW_PASSWORD'] = "Beim ändern des Passwortes ist ein Fehler aufgetreten";
...
$_ARRAYLANG['TXT_DOWNLOADS_SEARCH_DOWNLOAD'] = "Download suchen";
...
$_ARRAYLANG['TXT_DOWNLOADS_ADDITIONAL_OPTIONS'] = "Erweiterte Optionen";
...
$_ARRAYLANG['TXT_DOWNLOADS_EMPTY_NAME_ERROR'] = "Sie müssen zwingend einen Namen erfassen!";
...
$_ARRAYLANG['TXT_DOWNLOADS_ASSIGN_CATEGORIES'] = 'Kategorien zuweisen';
...
$_ARRAYLANG['TXT_DOWNLOADS_MAINTAIN_EXISTING_CATEGORY_ASSIGNMENT'] = 'Bestehende Kategorien-Zuweisung beibehalten';
$_ARRAYLANG['TXT_DOWNLOADS_OVERWRITE_EXISTING_CATEGORY_ASSIGNMENT'] = 'Bestehende Kategorien-Zuweisung überschreiben';
...
$_ARRAYLANG['TXT_DOWNLOADS_DOWNLOADS_ASSIGNED_SUCCESS'] = "Die Downloads wurden erfolgreich zugewiesen.";
$_ARRAYLANG['TXT_DOWNLOADS_CATEGORIES_OF_CATEGORY'] = "Kategorien innerhalb der Kategorie %s";
$_ARRAYLANG['TXT_DOWNLOADS_DOWNLOADS_OF_CATEGORY'] = "Downloads der Kategorie %s";
...
$_ARRAYLANG['TXT_DOWNLOADS_ADD_DOWNLOADS_TO_CATEGORY'] = "Bestehende Downloads der Kategorie zuweisen";
$_ARRAYLANG['TXT_DOWNLOADS_OVERVIEW_PAGE'] = "Übersichtsseite";
$_ARRAYLANG['TXT_DOWNLOADS_COL_COUNT'] = "Anzahl Spalten";
$_ARRAYLANG['TXT_DOWNLOADS_COL_COUNT_DESC'] = "Die Anzahl der Spalten, die auf der Übersichtsseite in der tabellenförmigen Auflistung dargestellt werden sollen. Beachten Sie, dass das Design wahrscheinlich auch noch angepasst werden muss!";
$_ARRAYLANG['TXT_DOWNLOADS_SUBCAT_COUNT'] = "Maximale Anzahl Unterkategorien";
$_ARRAYLANG['TXT_DOWNLOADS_SUBCAT_COUNT_DESC'] = "Die Maximale Anzahl Unterkategorien pro Kategorie, die bei der Übersichtsseite aufgelistet werden sollen.";
$_ARRAYLANG['TXT_DOWNLOADS_LIST_DOWNLOADS_CURRENT_LANG'] = 'Nur Downloads in erfasster Sprache anzeigen';
$_ARRAYLANG['TXT_DOWNLOADS_LIST_DOWNLOADS_CURRENT_LANG_DESC'] = 'Aktivieren Sie diese Option, um die Downloads nur in jenen Sprachen im Frontend anzuzeigen, in welchen diese erfasst wurden. Falls diese Option nicht aktiv ist, werden alle Downloads in jeder Sprache angezeigt.';
$_ARRAYLANG['TXT_DOWNLOADS_ATTRIBUTES'] = "Attribute";
$_ARRAYLANG['TXT_DOWNLOADS_ATTRIBUTES_DESC'] = "Wählen Sie hier die zur Verfügung stehenden Eigenschaften eines Downloads aus.";
$_ARRAYLANG['TXT_DOWNLOADS_SETTINGS_SORTING'] = "Sortierung";
$_ARRAYLANG['TXT_DOWNLOADS_SETTINGS_OPTION_DOWNLOADS'] = "Downloads";
$_ARRAYLANG['TXT_DOWNLOADS_SETTINGS_OPTION_SORTING_DESC'] = "Bestimmen Sie das standardmässige Sortierverhalten";
$_ARRAYLANG['TXT_DOWNLOADS_SETTINGS_CUSTOM_LABEL'] = "Individuell";
$_ARRAYLANG['TXT_DOWNLOADS_SETTINGS_ALPHABETIC_LABEL'] = "Alphabetisch";
$_ARRAYLANG['TXT_DOWNLOADS_SETTINGS_NEWESTTOOLDEST_LABEL'] = "Neuste zuerst";
$_ARRAYLANG['TXT_DOWNLOADS_SETTINGS_OLDESTTONEWEST_LABEL'] = "Älteste zuerst";
$_ARRAYLANG['TXT_DOWNLOADS_MOST_VIEWED_FILE_COUNT'] = "Anzahl am meisten angeschaute Downloads";
$_ARRAYLANG['TXT_DOWNLOADS_MOST_VIEWED_FILE_COUNT_DESC'] = "Die maximale Anzahl an Downloads die beim Block 'Am meisten angeschaute Downloads' aufgelistet werden sollen.";
$_ARRAYLANG['TXT_DOWNLOADS_MOST_DOWNLOADED_FILE_COUNT'] = "Anzahl am meisten herunter geladene Downloads";
$_ARRAYLANG['TXT_DOWNLOADS_MOST_DOWNLOADED_FILE_COUNT_DESC'] = "Die maximale Anzahl an Downloads die beim Block 'Am meisten herunter geladene Downloads' aufgelistet werden sollen.";
$_ARRAYLANG['TXT_DOWNLOADS_MOST_POPULAR_FILE_COUNT'] = "Anzahl beliebtester Downloads";
$_ARRAYLANG['TXT_DOWNLOADS_MOST_POPULAR_FILE_COUNT_DESC'] = "Die maximale Anzahl an Downloads die beim Block 'Beliebteste Downloads' angezeigt werden sollen.";
$_ARRAYLANG['TXT_DOWNLOADS_NEWEST_FILE_COUNT'] = "Anzahl neuste Downloads";
$_ARRAYLANG['TXT_DOWNLOADS_NEWEST_FILE_COUNT_DESC'] = "Die maximale Anzahl an Downloads die beim Block 'Neuste Downloads' angezeigt werden sollen.";
$_ARRAYLANG['TXT_DOWNLOADS_UPDATE_FILE_COUNT'] = "Anzahl kürzlich aktualisierte Downloads";
$_ARRAYLANG['TXT_DOWNLOADS_UPDATE_FILE_COUNT_DESC'] = "Die maximale Anzahl an Downloads die beim Block 'Kürzlich aktualisierte Downloads' aufgelistet werden sollen.";
$_ARRAYLANG['TXT_DOWNLOADS_NEW_FILE_TIME_LIMIT'] = "Zeitspanne zur Kennzeichnung von neuen Downloads";
$_ARRAYLANG['TXT_DOWNLOADS_NEW_FILE_TIME_LIMIT_DESC'] = "Definiert die Zeitspanne (in Sekunden) wie lange ein neu hinzugefügter Download als neu gekennzeichnet wird.";
...
$_ARRAYLANG['TXT_DOWNLOADS_RELATED_CATEGORIES'] = "Verwandte Kategorien";
...
$_ARRAYLANG['TXT_DOWNLOADS_DOWNLOADED'] = "Heruntergeladen";
$_ARRAYLANG['TXT_DOWNLOADS_VIEWED'] = "Angeschaut";
$_ARRAYLANG['TXT_DOWNLOADS_OPEN_CATEGORY_FRONTEND'] = "Kategorie im Frontend anzeigen";
$_ARRAYLANG['TXT_DOWNLOADS_ADD_NEW_DOWNLOAD_TO_CATEGORY'] = "Neuen Download zur Kategorie hinzufügen";
...
$_ARRAYLANG['TXT_DOWNLOADS_GROUPS'] = "Gruppen";
$_ARRAYLANG['TXT_DOWNLOADS_DETAIL_PAGE'] = "Detail Seite";
$_ARRAYLANG['TXT_DOWNLOADS_ADD_GROUP'] = "Gruppe hinzufügen";
$_ARRAYLANG['TXT_DOWNLOADS_EDIT_GROUP'] = "Gruppe bearbeiten";
$_ARRAYLANG['TXT_DOWNLOADS_CONFIRM_DELETE_GROUP'] = "Möchten Sie die Gruppe %s wirklich löschen?";
$_ARRAYLANG['TXT_DOWNLOADS_CONFIRM_DELETE_GROUPS'] = "Möchten Sie die ausgewählten Gruppen wirklich löschen?";
$_ARRAYLANG['TXT_DOWNLOADS_DEACTIVATE_GROUP_DESC'] = "Klicken Sie hier, um diese Gruppe zu deaktivieren";
$_ARRAYLANG['TXT_DOWNLOADS_ACTIVATE_GROUP_DESC'] = "Klicken Sie hier, um diese Gruppe zu aktivieren";
$_ARRAYLANG['TXT_DOWNLOADS_GROUPS_DELETE_SUCCESS'] = "Die Gruppen wurden erfolgreich gelöscht.";
$_ARRAYLANG['TXT_DOWNLOADS_GROUP_DELETE_SUCCESS'] = "Die Gruppe %s wurde erfolgreich gelöscht.";
$_ARRAYLANG['TXT_DOWNLOADS_NO_GROUPS_AVAILABLE'] = "Es sind keine Gruppen vorhanden.";
$_ARRAYLANG['TXT_DOWNLOADS_PLACEHOLDER'] = "Platzhalter";
...
$_ARRAYLANG['TXT_DOWNLOADS_EMAIL_TEMPLATES'] = 'E-Mail Vorlagen';
...
$_ARRAYLANG['TXT_DOWNLOADS_SETTINGS_SEARCH'] = "Suche";
$_ARRAYLANG['TXT_DOWNLOADS_INTEGRATE_INTO_SEARCH_COMPONENT'] = "Integration in der globalen Volltextsuche";
$_ARRAYLANG['TXT_DOWNLOADS_INTEGRATE_INTO_SEARCH_COMPONENT_TXT'] = "Aktivieren Sie diese Option, um die Downloads bei der globalen Volltextsuche mit einzubeziehen.";
$_ARRAYLANG['TXT_DOWNLOADS_SEARCH_LINK_METHOD'] = "Link-Verhalten der Suchresultate";
$_ARRAYLANG['TXT_DOWNLOADS_SEARCH_LINK_METHOD_DETAIL'] = "Detailansicht";
$_ARRAYLANG['TXT_DOWNLOADS_SEARCH_LINK_METHOD_ATTACHMENT'] = "Download (HTTP Content-Disposition %s)";
$_ARRAYLANG['TXT_DOWNLOADS_SEARCH_LINK_METHOD_INLINE'] = "Browseransicht (HTTP Content-Disposition %s)";
$_ARRAYLANG['TXT_DOWNLOADS_SETTINGS_STATISTICS'] = "Statistik";
$_ARRAYLANG['TXT_DOWNLOADS_CONTENT'] = "Inhalt";
$_ARRAYLANG['TXT_DOWNLOADS_PLACEHOLDERS'] = "Platzhalter";
$_ARRAYLANG['TXT_DOWNLOADS_KEY'] = "Key";
$_ARRAYLANG['TXT_DOWNLOADS_MAIL_KEY_ASSEST_NOTIFICATION'] = 'new_asset_notification';
$_ARRAYLANG['TXT_DOWNLOADS_DOMAIN_URL_DESC'] = 'Haupt Domain der Website';
$_ARRAYLANG['TXT_DOWNLOADS_FILE_OWNER_DESC'] = 'Name des hochladenden Benutzers';
...
$_ARRAYLANG['TXT_DOWNLOADS_SETTINGS_ASSET_SELECTION']       = "Asset Auswahl";
$_ARRAYLANG['TXT_DOWNLOADS_SETTINGS_AUTO_NAMING_DISABLE']   = "Deaktiviert";
$_ARRAYLANG['TXT_DOWNLOADS_SETTINGS_AUTO_NAMING_ENABLE']    = "Vorwahl des Asset Namens basierend auf der gewählten Quelle";
$_ARRAYLANG['TXT_DOWNLOADS_SETTINGS_AUTO_NAMING']           = "Automatische Namensgebung";
$_ARRAYLANG['TXT_DOWNLOADS_SETTINGS_PRETTY_FORMAT_TOOLTIP'] = 'Hinterlegen Sie hier einen regulären Ausdruck, welcher auf die Verzeichnis- und Dateinamen bei der Auflistung auf der Website angewendet werden soll.<br /><br /><strong>Beispiele</strong><br />Um Unterstriche durch Leerzeichen zu ersetzen, kann folgender Ausdruck hinterlegt werden:<br /><code>#_# #</code><br /><br />Um Dateiendungen auszublenden, kann folgender Ausdruck hinterlegt werden:<br /><code>#^(.*)(\..{2,4})$#\1#</code>';
