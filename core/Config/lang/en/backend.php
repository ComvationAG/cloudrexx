...
$_ARRAYLANG['TXT_CORE_CONFIG_CORESIMPLESELECTLIMIT_TOOLTIP_HELP'] = 'Number of data records that can be displayed in the simple select menu. If this number is exceeded, the simple selection menu is replaced by two select menus to improve clarity.';
