...
$_ARRAYLANG['TXT_CORE_CONFIG_SITE'] = 'Website';
$_ARRAYLANG['TXT_CORE_CONFIG_ADMINISTRATIONAREA'] = 'Administrationsoberfläche';
...
$_ARRAYLANG['TXT_CORE_CONFIG_COREGLOBALPAGETITLE_TOOLTIP_HELP'] = 'Globaler Seitentitel. Dieser kann in Ihrem Webdesign Theme mittels Platzhalter [[GLOBAL_TITLE]] eingebaut werden.';
...
$_ARRAYLANG['TXT_SETTINGS_FTP_USER'] = 'Benutzer';
$_ARRAYLANG['TXT_SETTINGS_FTP_PASSWORD'] = 'Kennwort';
$_ARRAYLANG['TXT_SETTINGS_RESET_PASSWORD'] = 'Kennwort zur&uuml;cksetzen';
$_ARRAYLANG['TXT_CORE_CONFIG_COREPAGINGLIMIT'] = 'Datensätze pro Seite';
$_ARRAYLANG['TXT_CORE_CONFIG_COREPAGINGLIMIT_TOOLTIP_HELP'] = 'Zwischen 1 und 200 möglich.';
$_ARRAYLANG['TXT_CORE_CONFIG_CORESIMPLESELECTLIMIT'] = 'Anzahl der Datensätze im einfachen Auswahlmenü';
$_ARRAYLANG['TXT_CORE_CONFIG_CORESIMPLESELECTLIMIT_TOOLTIP_HELP'] = 'Anzahl Datensätze, die im einfachen Auswahlmenü dargestellt werden können. Wird diese Anzahl überschritten, wird das einfache Auswahlmenü durch zwei Auswahlmenüs ersetzt, um die Übersichtlichkeit zu steigern.';
...
$_ARRAYLANG['TXT_CORE_CONFIG_CONTACTFORMEMAIL_TOOLTIP_HELP'] = 'Empfänger E-Mail Adressen für das Standardformular (keine id angegeben). Mehrere Empfängeradressen jeweils durch Kommas trennen.';
...
$_ARRAYLANG['TXT_CORE_CONFIG_CORELISTPROTECTEDPAGES_TOOLTIP_HELP'] = 'Dies definiert, ob bei der Navigation, Volltextsuche, Sitemap und XML-Sitemap auch geschützte Seiten aufgelistet werden sollen, wenn der Benutzer nicht authentifiziert ist - Status (on | off)';
...
$_ARRAYLANG['TXT_CORE_CONFIG_FORCEDOMAINURL_TOOLTIP_HELP'] = 'Durch Aktivierung dieser Option wird die Website ausschliesslich über die gewählte Hauptdomain bereit gestellt. Aktivieren Sie diese Option falls der E-Commerce Shop im Einsatz und/oder um bei Suchmaschinen ein besseres Ranking zu erlangen. Die Website ist dabei über allfällige Domain-Aliase weiterhin erreichbar.';
...
$_ARRAYLANG['TXT_IMAGE_THUMBNAILS_MAXIMUM'] = 'Maxmimal %s';
...
$_ARRAYLANG['TXT_CORE_CONFIG_COOKIENOTETTL']        = 'Cookie-Hinweis Lebensdauer';
$_ARRAYLANG['TXT_SETTINGS_COOKIENOTETTL_SESSION']   = 'Browsersitzung';
$_ARRAYLANG['TXT_SETTINGS_COOKIENOTETTL_WEEK']      = '1 Woche';
